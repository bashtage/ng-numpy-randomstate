...
IF RNG_PCG32:
    include "shims/pcg-32/pcg-32-defs.pxi"
IF RNG_PCG64:
    include "shims/pcg-64/pcg-64-defs.pxi"
IF RNG_MT19937:
...
IF RNG_MRG32K3A:
    include "shims/mrg32k3a/mrg32k3a-defs.pxi"
IF RNG_MLFG_1279_861:
    include "shims/mlfg-1279-861/mlfg-1279-861-defs.pxi"
IF RNG_DUMMY:
