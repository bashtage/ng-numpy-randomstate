...
void add_state(randomkit_state *state1, randomkit_state *state2) {
...
/*
void gen_vec_h(randomkit_state *state, randomkit_state *vec_h,
               unsigned long *h) {
  int i;
  unsigned long k, g;
  randomkit_state v;
...
/*
void calc_state(unsigned long *pf, randomkit_state *state,
                randomkit_state *vec_h) {
...
void horner1(unsigned long *pf, randomkit_state *state) {
  int i = MEXP - 1;
  randomkit_state *temp;

  temp = (randomkit_state *)calloc(1, sizeof(randomkit_state));
